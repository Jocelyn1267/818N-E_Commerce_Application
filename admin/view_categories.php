            ...
            <table class="table table-bordered table-hover table-striped text-center">
                ...
                <tbody>
                    <?php
                        ...
                        $get_category_result = mysqli_query($readCon,$get_category_query);
                        $id_number = 1;
                        while($row_fetch_categories = mysqli_fetch_array($get_category_result)){
                            ...
                            <td>
                                <a href='index.php?delete_category=$category_id' data-bs-toggle='modal' data-bs-target='#deleteModal_$category_id'>
