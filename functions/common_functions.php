...
function getProduct($numToDisplay = '')
{
    ...
    if (!isset($_GET['category'])) {
        if (!isset($_GET['brand'])) {
            ...
            $select_product_result = mysqli_query($readCon, $select_product_query);
...
function getBrands()
{
    ...
    $select_brands_result = mysqli_query($readCon, $select_brands_query);
...
function getCategories()
{
    ...
    $select_category_result = mysqli_query($readCon, $select_category_query);
...
function search_product()
{
    ...
    if (isset($_GET['search_data_btn'])) {
        ...
        $search_product_result = mysqli_query($readCon, $search_product_query);
...
function cart_item()
{
    if (isset($_GET['add_to_cart'])) {
        ...
        $select_result = mysqli_query($readCon, $select_query);
...
function total_cart_price()
{
    ...
    $cart_result = mysqli_query($readCon, $cart_query);
...
function get_user_order_details()
{
    ...
    $get_details_result = mysqli_query($readCon, $get_details_query);
        ...
        if (!isset($_GET['edit_account'])) {
            if (!isset($_GET['my_orders'])) {
                if (!isset($_GET['delete_account'])) {
                    ...
                    $get_orders_result = mysqli_query($readCon,$get_orders_query);
